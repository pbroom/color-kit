import { createPlaneQuery, definePlane, toSvgPath } from '@color-kit/core';

// @ck-snippet-compact-start
const resolvedPlane = definePlane({ fixed: { h: 250, alpha: 1 } });
...
export default App;
export { App as PlaneQuickStartTsxDemo };
