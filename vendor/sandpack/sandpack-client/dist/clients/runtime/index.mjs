import { _ as __awaiter, a as __generator, h as __assign, i as __spreadArray, g as __extends, n as nullthrows, e as extractErrorDetails, b as createPackageJSON, c as createError, S as SandpackLogLevel, d as addPackageJSONIfNeeded } from '../../utils-52664384.mjs';
...
function summarizeSetup(setup) {
    var filePaths = Object.keys(setup.files);
    return {
        template: setup.template,
        fileCount: filePaths.length,
        firstPaths: filePaths.slice(0, 5),
        hasDependencies: Boolean(setup.dependencies),
        hasDevDependencies: Boolean(setup.devDependencies),
    };
}
var SandpackRuntime = /** @class */ (function (_super) {
    ...
    function SandpackRuntime(selector, sandboxSetup, options) {
        ...
        emitDebugEvent("client:runtime:init", __assign({ bundlerURL: _this.bundlerURL, startRoute: options.startRoute }, summarizeSetup(sandboxSetup)));
        ...
        _this.unsubscribeGlobalListener = _this.iframeProtocol.globalListen(function (mes) {
            ...
            emitDebugEvent("client:runtime:initialized", __assign({ bundlerURL: _this.bundlerURL }, summarizeSetup(_this.sandboxSetup)));
        ...
        _this.unsubscribeChannelListener = _this.iframeProtocol.channelListen(function (mes) {
            switch (mes.type) {
                case "start": {
                    _this.errors = [];
                    emitDebugEvent("client:runtime:message", { type: mes.type });
                    break;
                }
                case "status": {
                    _this.status = mes.status;
                    emitDebugEvent("client:runtime:status", {
                        status: mes.status,
                    });
                    break;
                }
                case "action": {
                    ...
                    emitDebugEvent("client:runtime:message", {
                        type: mes.type,
                        action: mes.action,
                    });
                    break;
                ...
                case "done": {
                    _this.status = "done";
                    emitDebugEvent("client:runtime:done", {
                        compilationError: mes.compilatonError,
                    });
                    break;
                }
                case "state": {
                    _this.bundlerState = mes.state;
                    emitDebugEvent("client:runtime:state", {
                        entry: mes.state.entry,
                    });
                    break;
                }
            }
    ...
    SandpackRuntime.prototype.destroy = function () {
        emitDebugEvent("client:runtime:destroy", {
            status: this.status,
    ...
    SandpackRuntime.prototype.updateSandbox = function (sandboxSetup, isInitializationCompile) {
        ...
        emitDebugEvent("client:runtime:update-sandbox", __assign({ isInitializationCompile: Boolean(isInitializationCompile), status: this.status }, summarizeSetup(this.sandboxSetup)));
    ...
    SandpackRuntime.prototype.dispatch = function (message) {
        ...
        if (message.type === "refresh") {
            emitDebugEvent("client:runtime:refresh", {
                bundlerURL: this.bundlerURL,
            });
        ...
        emitDebugEvent("client:runtime:dispatch", {
            type: message.type,
