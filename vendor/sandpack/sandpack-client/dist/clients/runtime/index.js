...
var SandpackRuntime = /** @class */ (function (_super) {
    ...
    function SandpackRuntime(selector, sandboxSetup, options) {
        ...
        debug.emitDebugEvent("client:runtime:init", utils.__assign({ bundlerURL: _this.bundlerURL, startRoute: options.startRoute }, summarizeSetup(sandboxSetup)));
        ...
        _this.unsubscribeGlobalListener = _this.iframeProtocol.globalListen(function (mes) {
            ...
            debug.emitDebugEvent("client:runtime:initialized", utils.__assign({ bundlerURL: _this.bundlerURL }, summarizeSetup(_this.sandboxSetup)));
        ...
        _this.unsubscribeChannelListener = _this.iframeProtocol.channelListen(function (mes) {
            switch (mes.type) {
                case "start": {
                    _this.errors = [];
                    debug.emitDebugEvent("client:runtime:message", { type: mes.type });
                    break;
                }
                case "status": {
                    _this.status = mes.status;
                    debug.emitDebugEvent("client:runtime:status", {
                        status: mes.status,
                    });
                    break;
                }
                case "action": {
                    ...
                    debug.emitDebugEvent("client:runtime:message", {
                        type: mes.type,
                        action: mes.action,
                    });
                    break;
                ...
                case "done": {
                    _this.status = "done";
                    debug.emitDebugEvent("client:runtime:done", {
                ...
                case "state": {
                    ...
                    debug.emitDebugEvent("client:runtime:state", {
    ...
    SandpackRuntime.prototype.destroy = function () {
        debug.emitDebugEvent("client:runtime:destroy", {
            status: this.status,
    ...
    SandpackRuntime.prototype.updateSandbox = function (sandboxSetup, isInitializationCompile) {
        ...
        debug.emitDebugEvent("client:runtime:update-sandbox", utils.__assign({ isInitializationCompile: Boolean(isInitializationCompile), status: this.status }, summarizeSetup(this.sandboxSetup)));
    ...
    SandpackRuntime.prototype.dispatch = function (message) {
        ...
        if (message.type === "refresh") {
            debug.emitDebugEvent("client:runtime:refresh", {
                bundlerURL: this.bundlerURL,
            });
        ...
        debug.emitDebugEvent("client:runtime:dispatch", {
            type: message.type,
