...
- **Rebase with autostash can surface stale conflicts**: If `--autostash` replays with conflicts, resolve and stage the conflicted file immediately before continuing, so fast-forward merges stay clean.
