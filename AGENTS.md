...
- **2026-04-04 — CI autofix claim lock**: Use the `ci-fail-<checks>` AutomationMemory timestamp lock before investigating CI failures so only one automation run claims and fixes a given failure set.
